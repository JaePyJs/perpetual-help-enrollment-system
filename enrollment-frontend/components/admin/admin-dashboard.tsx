          ...
          <TabsContent value="users" className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent className="space-y-2">
                  <p className="text-sm text-muted-foreground">
                    ...
                    Edit user details, reset passwords, and manage account
                    status.
                  </p>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <p className="text-sm text-muted-foreground">
                    Register new students with all required information
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <p className="text-sm text-muted-foreground">
                    Register new teachers with all required information
                    including personal details, specializations, and account
                    credentials.
                  </p>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <p className="text-sm text-muted-foreground">
                    Monitor all user actions and system events with detailed
                    audit logs. Filter by action type, user, date range, and
                    more.
                  </p>
