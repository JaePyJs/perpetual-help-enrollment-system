...
export function RecentAnnouncements() {
  const announcements = [
    ...
    },
    {
      ...
      content:
        "The computer lab in Building B will now be open 24/7 for student use during the exam period.",
      date: "July 12, 2023",
      author: {
        name: "IT Department",
        avatar: "/placeholder.svg?height=32&width=32",
    ...
    },
    {
      ...
      content:
        "Join us for a guest lecture by Dr. Jane Smith on 'Advanced Computing Technologies' on July 20 at 3:00 PM in Auditorium A.",
      date: "July 10, 2023",
      author: {
      ...
      {announcements.map((announcement) => (
        <div key={announcement.id} className="space-y-2">
          <div className="flex items-start justify-between">
            ...
            <Badge
              variant="outline"
              className={getBadgeVariant(announcement.type)}
            >
              {announcement.type}
            </Badge>
          </div>
