...
// Get all subjects (public, but only non-sensitive fields)
router.get("/", async (req, res) => {
  try {
    ...
    const subjects = await Subject.find(query)
      .select(
        "code title units department yearLevel semester prerequisites corequisites"
      )
...
router.put("/:id", auth, checkRole(["admin"]), async (req, res) => {
  try {
    ...
    if (units) {
      ...
      subject.units.total =
        (units.lecture || subject.units.lecture) +
        (units.laboratory || subject.units.laboratory);
    }
    ...
    try {
      ...
      if (department === "BSIT") {
        ...
        subjects.push({
          ...
          description:
            "A study of the self, its development, and its relationship with others.",
          units: {
            lecture: 3,
            laboratory: 0,
            total: 3,
        ...
        subjects.push({
          ...
          description:
            "Development of communication skills for academic and professional purposes.",
          units: {
            lecture: 3,
            laboratory: 0,
            total: 3,
        ...
        subjects.push({
          ...
          description:
            "Study of data structures and algorithms for efficient program design.",
          units: {
            lecture: 2,
            laboratory: 1,
            total: 3,
        ...
        subjects.push({
          ...
          description:
            "Basic concepts of computer science and computational thinking.",
          units: {
            lecture: 3,
            laboratory: 0,
            total: 3,
