  ...
  const columns: ColumnDef<AuditLog>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <Badge variant={role === "global-admin" ? "destructive" : role === "admin" ? "default" : "secondary"}>
            {role}
          </Badge>
        )
      },
    },
    {
      ...
      cell: ({ row }) => {
        ...
        } else if (action.includes("delete") || action.includes("deactivate") || action.includes("failure")) {
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>Filter audit logs by action, user role, date range, or search</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              <Label htmlFor="role-filter" className="mb-2 block">User Role</Label>
